{
  ...
  "package": {
    "name": "ClockDivBy1000",
    "version": "1.01",
    "description": "clock/1000, only for measuringFpga internall fast clock (eg: PLL) frequencies with a low speed logic analyser",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "50149889-b9dc-4ce7-928b-1ad4714acf44",
          "type": "basic.input",
          "data": {
            "name": "clk",
            "pins": [
        ...
        {
          "id": "cadb26fa-fd3c-48aa-95fd-af621add3298",
          "type": "basic.output",
          "data": {
            "name": "clk_freq/1000",
            "pins": [
        ...
        {
          "id": "063ca976-9e00-48e1-acb3-028961d30f4b",
          "type": "basic.constant",
          "data": {
            "name": "N",
            "value": "500",
        ...
        {
          "id": "f58bce5f-ffd9-48aa-93fa-fe7151b6c72f",
        ...
        {
          "id": "1e80a395-5445-4077-b978-6fec56b6f9e6",
        ...
        {
          "id": "cb1d140c-669f-4791-90de-e2e34bf70096",
        ...
        {
          "id": "3e87e750-0fde-47a6-af49-e14d56a49c44",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "ba2568d9-3aad-40ce-879c-c486941e9ba9",
      ...
      "wires": [
        {
          "source": {
            "block": "063ca976-9e00-48e1-acb3-028961d30f4b",
            "port": "constant-out"
          },
          "target": {
            "block": "f58bce5f-ffd9-48aa-93fa-fe7151b6c72f",
        ...
        {
          "source": {
            "block": "50149889-b9dc-4ce7-928b-1ad4714acf44",
            "port": "out"
          },
          "target": {
            "block": "1e80a395-5445-4077-b978-6fec56b6f9e6",
        ...
        {
          "source": {
            "block": "cb1d140c-669f-4791-90de-e2e34bf70096",
        ...
        {
          "source": {
            "block": "ba2568d9-3aad-40ce-879c-c486941e9ba9",
            "port": "aa84d31e-cd92-44c7-bb38-c7a4cd903a78"
          },
          "target": {
            "block": "cadb26fa-fd3c-48aa-95fd-af621add3298",
            "port": "in"
          },
          "vertices": []
        },
